...
taking patient age into account):
    ...
    ##                  average min. max. stdr.deviation     C.V.    25% 50%   75%
...
Descriptive summary of numeric variables:
    ...
    ##                               average      min.         max. stdr.deviation
    ...
    ## TransCarrierAll            0.03732812 0.0000000    0.6790000     0.07730452
...
exceptions) in the country. Which means that there are cities with no
fertility clinic.
...
How would a negative binomial distribution with a mean of and that *k*
value describe our count data? The expected frequencies are obtained by
multiplying the probability density by the total sample size ( in this
case).

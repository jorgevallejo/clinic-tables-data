...
```{r contingency-table-clinics-frequency}
...
```{r cities-with-and-without-clinics}
...
```{r barplot-clinics-by-city-logarithmic}
...
```{r max-like-estimate-of-k-for-freq}
...
```{r expected-frequencies-neg-binom}

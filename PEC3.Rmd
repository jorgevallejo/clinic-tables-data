...
download.file(source_url, destfile = "FINAL-2017-Clinic-Table-Dataset.xlsx", method = "curl")
```
...
```{r}
require("xlsx")
clinic_dictionary <- read.xlsx("FINAL-2017-Clinic-Table-Dataset.xlsx", 4,
...
clinic_data <- read.xlsx("FINAL-2017-Clinic-Table-Dataset.xlsx", 3

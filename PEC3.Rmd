...
Seen the data represented, we can see that [gestational carriers minority; frozen embryos and icsi are very used]
...
For anyone interested, a quick query in a serch engine provides us with the website of the clinic:

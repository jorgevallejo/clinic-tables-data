...
Which informs us that we got `r clinics_frequency[[1]]` cities with one fertility clinic in them, and one city with `r clinics_frequency[[length(clinics_frequency)]]` clinics in it. 

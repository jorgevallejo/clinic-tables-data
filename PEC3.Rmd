...
```{r process-fractions, warning=FALSE}
...
```{r histograms-transfers-donor, fig.cap="Bar width represents a range of 10 transfers"}
...
```{r boxplot-intended-retrievals-by-age}
...
```{r boxplot-intended-retrievals-live-births}
...
```{r boxplot-egg-retrieval, fig.height = 15, fig.width = 8}
...
```{r boxplot-intended-egg-retrievals, fig.height = 30, fig.width = 8}
...
```{r boxplot-transfers, fig.height = 15, fig.width = 8}
...
```{r boxplot-transfers-from-donor, fig.height = 15, fig.width = 8}
...
```{r boxplot-ratio-transfers-by-age, fig.height = 20, fig.width = 8}
...
```{r boxplot-cycles-by-age, fig.width = 8}
...
```{r boxplot-interruted-cycles, fig.width = 8}
...
```{r fertility-preservation-clinic}
...
```{r boxplot-cancelled-cycles, fig.width = 8}
...
```{r boxplot-stopped-cycles, fig.width = 8}
...
```{r boxplot-fertility-preservation, fig.width = 8}
...
```{r boxplot-cause-of-cycles, fig.width = 8}
...
```{r table-ratio-transfers-to-ratio-gestational}

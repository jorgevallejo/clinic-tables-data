...
In short, **the data doesn't show any correlation between the size of the clinic (measured in total number of ART cycles) and the ratio of living birts per transfer**.  
Which is good news, since it means that little clinics are as effective at achieving living births after transfer as big clinics are.

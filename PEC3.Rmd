...
Given the fit, I would say that the variable ND_IntentRetLB2 follows a **normal distribution** with mean `mean(clinic_data$ND_IntentRetLB2, na.rm = TRUE)` and variance `var(clinic_data$ND_IntentRetLB2, na.rm = TRUE)`.

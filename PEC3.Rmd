...
# Next is from https://stackoverflow.com/questions/39662365/knit-one-markdown-file-to-two-output-files/53280491#53280491
...
## Gestational carriers, frozen embryos and ICSI
...
In the next graph we will represent the data of the ratio of transfers that use a gestational carriers, those that use frozen embryos, and those in which at least one embryo has been obtained by ICSI:

```{r fig.width = 8}

# Ratio of transfers (gestational carriers, frozen embryos, ICSI)
boxplot(clinic_data[c(123, 129, 135)],
        xlab = "Groups",
        ylab = "Ratio",
        main = bquote("Ratio of Transfers Using Gestational Carriers, Frozen Embryos, or ICSI"),
        names = c("Gestational Carriers", "Frozen Embryos", "ICSI"),
        col = "aliceblue")
```

Seen the data represented, we can say that gestational carrier transfers are a minority in most of the clinics, with notable exceptions. On the other hand, both the use of frozen embryos, and the ICSI technique are normalized and very frequent.
...
We can break down the ratios of transfers into age groups for gestational carriers, transfers of frozen embryos, and of embryos obtained by ICSI.  
